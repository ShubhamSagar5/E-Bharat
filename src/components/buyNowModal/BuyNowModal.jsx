...
const BuyNowModal = ({ addressInfo, setAddressInfo, buyNowFunction }) => {
    ...
    return (
        <>
            ...
            <Dialog open={open} handler={handleOpen} className=" bg-pink-50  mt-[230px] md:mt-[180px] w-[380px] h-[400px] md:w-[800px] md:h-[400px] bg-opacity-110 mx-auto p-2  ">
                <DialogBody className=" h-[200px] w-11/12">
                    <div className="mb-5 ">
                        <input
                            type="text"
                            name="name"
